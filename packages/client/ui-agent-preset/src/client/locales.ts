...
export type AgentPresetSettingsKey =
  ...
  | 'presetCodexName' | 'presetCodexDescription'
...
export const en: Record<AgentPresetSettingsKey, string> = {
  ...
  presetCodexName: 'Codex search mode',
  presetCodexDescription:
    "Full coding agent that delegates web research to the official Codex CLI's native websearch instead of DSH's web_search.",
  duplicate: 'Duplicate',
...
export const zh: Record<AgentPresetSettingsKey, string> = {
  ...
  presetCodexName: 'Codex 搜索模式',
  presetCodexDescription: '完整编码 Agent；网络检索委托给官方 Codex CLI 的原生 websearch，不使用 DSH 的 web_search。',
  duplicate: '复制',
...
const BUILT_IN_PRESET_KEYS: Readonly<Partial<Record<string, PresetLocaleKeys>>> = {
  ...
  codex: { name: 'presetCodexName', description: 'presetCodexDescription' },
}
