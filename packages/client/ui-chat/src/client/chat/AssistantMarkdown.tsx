 ...
 * @returns The API URL for an absolute POSIX or Windows path on an HTTP(S) page, or
...
export function localPathMediaUrl(protocol: string, origin: string, value: string): string | undefined {
  ...
  if (value.length === 0 || (!value.startsWith('/') && !windowsAbsolute) || value.startsWith('//')) return undefined
