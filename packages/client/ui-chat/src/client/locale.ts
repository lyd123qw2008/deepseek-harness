...
export const zh = {
  ...
  'settings.fileOpenTarget.title': '文件与链接打开位置',
  'settings.fileOpenTarget.description': '控制对话中的文件链接、网页链接和工具路径操作',
  'settings.fileOpenTarget.host': '默认应用',
  'settings.fileOpenTarget.sidebar': '侧边栏预览',
...
export const en = {
  ...
  'settings.fileOpenTarget.title': 'File and link opening',
  'settings.fileOpenTarget.description': 'Controls file links, web links, and tool-path actions in Chat',
  'settings.fileOpenTarget.host': 'Default application',
  'settings.fileOpenTarget.sidebar': 'Sidebar preview',
