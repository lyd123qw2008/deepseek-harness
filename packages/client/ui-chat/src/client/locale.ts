...
export const zh = {
  ...
  'settings.fileOpenTarget.title': '文件打开位置',
  'settings.fileOpenTarget.description': '控制对话中的文件链接和工具路径操作',
...
export const en = {
  ...
  'settings.fileOpenTarget.title': 'File opening location',
  'settings.fileOpenTarget.description': 'Controls file links and tool-path actions in Chat',
