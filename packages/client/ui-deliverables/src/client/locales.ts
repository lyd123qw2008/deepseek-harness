...
export const zh = {
  ...
  'presented.defaultAppAria': '用默认应用打开 {name}',
  'presented.more': '{name} 的更多文件操作',
  'presented.action': '预览',
  'presented.preview': '在侧边栏预览',
  'presented.previewButton': '预览 {name}',
...
export const en: Record<DeliverablesKey, string> = {
  ...
  'presented.defaultAppAria': 'Open {name} in default app',
  'presented.more': 'More file actions for {name}',
  'presented.action': 'Preview',
  'presented.preview': 'Preview in sidebar',
  'presented.previewButton': 'Preview {name}',
