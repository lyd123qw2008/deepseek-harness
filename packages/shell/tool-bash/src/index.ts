...
import { ESCALATION_TARGETS, approveEscalation, canonicalPath, isRedundantEscalation, validateEscalationArgs } from '@deepseek-ai/dsh-sandbox'
...
export function apply(ctx: Context, config: Config = {}): void {
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: BashToolArgs, exec) {
      ...
      const approvedMode = !redundantEscalation && args.sandbox_permissions !== undefined && args.justification !== undefined
